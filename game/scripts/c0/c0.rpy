label c0:
    ...
    by "待会有人进来，我不能这样跟你说话……你要是真的能“看见”什么，记得告诉我。"
    ...
    by "我只记得周四，我跟平时一样上学放学，晚上在家里睡觉。然后醒来之后……就是刚才了。"
    xp "之前的事情还记得？只有这两天的事忘了？"
    by "嗯……对。"
    xp "没有发生过其他事情吗？任何不确定的细节都可以。"
    by "……没有。"
    "短发女人没再说话，安静地坐在凳子上。"
    "正当白一开始觉得不耐烦，要开口询问时，门再次被打开，另一个长发女人走了进来。"
    xs "这位同学，知道“特调组”吗？"
    by "……啊？"
    "白一显得十分疑惑，但大概是学生的本能，还是老老实实地回答。"
    by "特别案件调查组……是吧。所以，是不是有什么危险的事情，跟我有关，所以你们才……？"
