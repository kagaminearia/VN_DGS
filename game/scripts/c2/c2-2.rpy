...
label c2_2_extra:
    ...
    by "啊？那你竟然能忍到现在才问？"
    me "我以为是小名啊，没太在意……"
    by "名字要解释的话确实比较复杂……让我想想。嗯，以前的话，名字是分姓和名的，名是家长取，姓就是跟着家长嘛。"
    me "是啊，我知道，所以难道现在不是吗？"
    by "现在的话，四六开吧，多数人的名字是和家里人没关系的。"
    by "在信息系统上还是有分姓和名，但姓和名是分开记录，姓的位置可以空着，只要有名字就可以。"
    by "成年以后，可以自己给自己改姓，在名字前加一个姓，或者就保留原状。"
    by "哦还有，有些人结婚之后，也会和自己伴侣选择同一个姓一起改，算是一种仪式感吧。"
    by "比如姒舞成年之后可以叫苏姒舞，或者苏舞，看她的名字是怎么登记的。"
    by "天玉结婚后可以从云天玉改成祝天玉之类的。当然，她应该是不会改名的啦……"
    me "嗯？为什么这么说？"
    by "她家里人让她用了姓，说明这很重要啊，当然不会改了。"
    by "之前不是说了嘛，大概有四成人会让孩子跟着家长姓。"
    by "这种情况呢要么是家庭环境比较传统，要么是有家族企业需要继承，要么就是个人喜好。"
    by "像天玉这种大小姐，当然也是在这类人里的咯。"
    me "听起来很复杂。"
    by "对啊，所以我们平时就是，别人说怎么叫称呼，直接叫就完了。"
    by "姓啊名啊，都是信息系统上的事。天玉说她叫天玉，那我们就叫她天玉，别的，那都不是我们需要思考的事。"
