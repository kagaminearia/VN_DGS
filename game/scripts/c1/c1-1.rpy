label c1_1:
    ...
    "白一的心脏跳得很快，我的心脏也跳得很快。又或者，是我正在清晰感受着她的心跳。"
    me "……她是什么意思？难道她知道什么……？"
    "我有些不安地开口，白一则是捏紧了手掌。"
    ...
    hide xsimg
    show xsimg laugh behind tophalfblk at char_mid 
    xs "我确实知道一些东西，你不想问吗？"
    ...
    by eye_move def "……哦。"
    "没有生气，意外的好态度让白一都有些愣神，好一会才闷闷地应了一声。"
    hide xsimg
    ...
    hide xsimg
    show xsimg o at char_mid
    xs "12月11日下午，民案组接到报案，有人发现了你的尸体。"
    by eye_wacky e "……发现了什么？"
    hide xsimg
    show xsimg at char_mid
    ...
    hide xsimg
    show xsimg o at char_mid
    xs "好了，今天很晚了。也不至于要让你不眠不休，但之后的时间就麻烦你继续配合啰。"
    by eye_move def "……哦。"
    ...
    "西顺也没有在这个话题上继续，只是重新拿起资料，一阵窸窸窣窣后抽出其中一份递给白一。"
    ...
    "白一系紧鞋带，倏地站起身。"
    "只剩下最后一句轻飘飘的话，{w=1.5}颤抖着散落在冰冷的空气中。"
    ...
    me "噗嗤……谁知道呢。"
    by eye_wacky def "啧……你再笑我砍死你。"
    me "……"
    "我不敢说话了，总觉得她真的能做出这种伤敌八百自损一千的事情。"
    # 【客厅-餐桌】抽屉里有一双木质筷子，一双用过后洗干净的一次性筷子，上面刻有“湘味”的字迹。（同学捡起来洗完收好，没被大小姐发现）
    ...
    by eye_def o "她会把用过的一次性筷子收起来，平时应该很节约，然后习惯了。"
