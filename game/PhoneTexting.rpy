...
screen nvl_phonetext(dialogue):
    ...
    for id_d, d in enumerate(dialogue):
        if d.who == None: # Narrator
            ...
            if d.who == MC_Name:
                $ message_frame = "gui/phone/phone_send_frame.png"
            else:
                $ message_frame = "gui/phone/phone_received_frame.png"
            ...
            hbox:
                ...
                if previous_d_who != d.who:
                    if d.who == MC_Name:
                        $ message_icon = "gui/phone/phone_send_icon.png"
                    else:
                        $ message_icon = "gui/phone/phone_received_icon.png"
...
style phoneFrame_frame:
    background Transform("gui/phone/phone_background.png", xcenter=0.5,yalign=0.5)
    foreground Transform("gui/phone/phone_foreground.png", xcenter=0.5,yalign=0.5)
