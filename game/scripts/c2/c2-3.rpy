label c2_3:
    ...
    # 【蜡烛】放在床头柜上，已经烧完了。透过留给灯芯的洞，能够看到容器里剩下的浅浅一层像是碎屑的残留物。
    # 【杯子】在茶几边缘，里面有干涸的水渍和浸透的茶包。
    # 【内门】连接202房间，可以把两间房变成大号套房的两扇门。轻轻掩着，都没有上锁。
    # 【洗手间地面】有一个长条形的，类似椭圆的痕迹，不太清晰。
    # 【墙面】二楼平面图，标注了各个房间的位置以及消防电梯的位置
    xs "你看出什么了吗？"
    xs "哦，对了，你先看这个。"
