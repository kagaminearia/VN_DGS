label c1_1:
    ...
    hide xsimg
    show xsimg o at char_mid
    xs "我明白你的意思，也没有不想跟你说，之前是有别的因素要考虑。"
    by eye_move o "……哦。"
    ...
    hide xsimg
    show xsimg eye_close o at char_mid
    xs "刚刚我们在谈话中已经确认了，你现在是清醒的，你身上的怪异特性也没有影响你本人的身体，至少目前没有。"
    ...
    xs "你没听错，是你的尸体，当时没有生命体征。"
    xs "他们认为是意外死亡，所以送回来之后也没有进行多余的检查，只是等通知家属来认领。"
    xs "只是，他们的流程还没走完，你半夜突然醒过来了。或者说，重新活过来了。"
    by eye_wacky o "……擦。"
    me "……这合理吗？"
    by eye_wacky o "我也想知道，这合理吗？？"
    hide xsimg
    show xsimg eye_close o at char_mid
    ...
    by eye_wacky e "她吓得够呛？我才要被吓死了。刚好，死了也不用搬运，直接躺下完事。"
    ...
    by eye_def o "我没有，能不能现在就让她从我身体里滚蛋。"
    xs "我只能说，会尽力。"
    xs "不过，在那之前还有些事要解决，会影响对你后续的处理。"
    by eye_wacky o "到底还有什么，怎么这么多事？"
    hide xsimg
    show xsimg at char_mid
    "白一的耐心实在不多，就算是被城安局吓到，好脾气也几乎要耗尽了。"
    ...
    by eye_wacky o "我是失忆，不是傻逼，怎么可能会做这种傻逼事。"
    xs "这不是你或者我说了算的。"
    hide xsimg
    show xsimg o at char_mid
    xs "现在先不着急，但之后的时间就麻烦你继续配合啰。"
    by eye_move def "……哦。"
    ...
    by eye_def o "你会被饿死吗？"
    me "啊？"
    by eye_def e "……算了，你死不死都无所谓，今天午饭没了。"
    "她把菜刀摔在灶台上，囫囵地把一坨肉泥塞进保鲜膜，扔到冰箱里。"
    "然后，她砰地一下，把自己扔回床上，呆呆地看着天花板。"
    me "呃，其实……切坏了也能做菜？"
    by eye_wacky e "用你说？我知道。没心情而已。"
    by eye_close e "很烦，很困，很冷，还要出门。"
    ...
    by eye_move def "没啥。只是在想，会不会真的是我杀了她。"
    by eye_move smile "呵呵……毕竟我真的什么都不记得了，甚至还会诈尸，还被你这种东西缠上，好像什么都有可能。"
    by eye_close o "算了，我就随便说说，怎样都无所谓……"
    "虽然她这么说，但我似乎能感觉到……她的喉咙发干，心脏也跳得十分慌乱。"
    "也许，不，一定……并没有她嘴上说的那么轻松。"
    by eye_move def "啧……受不了，冷得要死……不下雪的降温，简直就是耍流氓。"
    "白一系紧鞋带，倏地站起身。"
    ...
    by eye_def def "哦……"
    by eye_still def "{size=23}看来，还是得看你了，我肯定想不起来。{/size}"
    "白一这句话说得很轻，我知道她是对我说的。"
